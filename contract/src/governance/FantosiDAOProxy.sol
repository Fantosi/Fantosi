...
// FantosiDAOProxy.sol is a modified version of FantosiDAOProxy.sol, tailored for the DAO's V2.
// Its main purpose is to support people wishing to deploy V2 directly, without having to deploy V1 first and then upgrade.

// LICENSE
// FantosiDAOProxy.sol is a modified version of Compound Lab's GovernorBravoDelegator.sol:
...
//
//
// FantosiDAOProxy.sol uses parts of Open Zeppelin's Proxy.sol:
...
contract FantosiDAOProxy is FantosiDAOStorageV2, FantosiDAOEvents {
    ...
    function _setImplementation(address implementation_) public {
        require(msg.sender == admin, "FantosiDAOProxy::_setImplementation: admin only");
        require(implementation_ != address(0), "FantosiDAOProxy::_setImplementation: invalid implementation address");
